...
docker run --rm --volumes-from ${HOSTNAME} --user=0:0 -e NPM_CONFIG_CACHE=${WORKDIR}/.npm ${DOCKER_CONTAINER_NAME} rm -rf .sauce.tid 75d8cd802a7b40bf2f41ee2eea1c0ff8.browserify *.log string
